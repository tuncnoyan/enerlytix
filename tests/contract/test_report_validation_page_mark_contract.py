...
from sitesync.models import Site, Team, UserTeamAssignment
...
class ReportValidationPageMarkContractTests(TestCase):
    ...
    def test_page_mark_returns_page_and_summary(self):
        ...
        response = self.client.post(
            reverse(
                ...
                kwargs={"report_id": self.report.id, "page_key": "overview-table"},
            ),
            {"is_validated": "true"},
    ...
    def test_page_mark_rejects_unknown_page(self):
        ...
        response = self.client.post(
            reverse(
                "sitesync:report_validation_page_toggle",
                kwargs={"report_id": self.report.id, "page_key": "unknown-page"},
            ),
            {"is_validated": "true"},
            HTTP_X_REQUESTED_WITH="XMLHttpRequest",
        )
