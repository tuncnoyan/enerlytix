...
urlpatterns = [
    ...
    path('api/import-review-sites/', views.admin_import_review_sites_api_view, name='admin_import_review_sites_api'),
    path('api/import-review-supplies/', views.admin_import_review_supplies_api_view, name='admin_import_review_supplies_api'),
    ...
    path('panel/imports/', views.admin_import_review_view, name='admin_import_review'),
    path('panel/imports/results/', views.admin_import_review_results_view, name='admin_import_review_results'),
    path('panel/imports/export.csv', views.admin_import_review_export_csv_view, name='admin_import_review_export_csv'),
    path('panel/imports/export.xlsx', views.admin_import_review_export_xlsx_view, name='admin_import_review_export_xlsx'),
